 ...
 *
 */
public class SerialImpl implements Serial, SerialPortEventListener {
	...
	public SerialImpl(String port, int rate) throws Exception {
		...
		System.out.println("@Raspberry ---> READY <--- Arduino@");
	}
	...
	@Override
	public String waitForMsg() throws InterruptedException {
